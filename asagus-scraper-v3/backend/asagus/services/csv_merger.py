...
class DownloadToolsCSVMerger:
    ...
    def merge_all_csvs(self, output_path: Path | None = None) -> dict[str, Any]:
        """Merge all CSV files from Download tools into one."""
        ...
        fieldnames = [
            ...
            "description", "hours", "price_level", "place_id", "cid",
        ]
